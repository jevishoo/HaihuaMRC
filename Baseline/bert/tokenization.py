...
from bert.utils import InputFeature, select_field


def process(data, bert_config, batch_size, max_length, threshold=None):
    """
    Parameters@
    ...
    for example in data:
        ...
        for qa, para in zip(example.pair, example.context):
            count += 1
            #
            # print("=========================")
            # print(para)
